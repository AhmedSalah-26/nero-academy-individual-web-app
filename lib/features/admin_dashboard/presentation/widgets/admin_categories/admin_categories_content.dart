...
class AdminCategoriesContent extends StatefulWidget {
  const AdminCategoriesContent({super.key});

  @override
  State<AdminCategoriesContent> createState() => _AdminCategoriesContentState();
}

class _AdminCategoriesContentState extends State<AdminCategoriesContent> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildCategoriesList(
    ...
    return RefreshIndicator(
      onRefresh: () => context.read<AdminCategoriesCubit>().loadCategories(
